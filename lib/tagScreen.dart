          ...
          Container(
            ...
            child: Text.rich(TextSpan(children: [
              ...
              TextSpan(text: phoneNumber,style: paraBoldText),
               email!="e"?   TextSpan(text: ". You can contact me (email) at ",style: paraText):TextSpan(text: ""),
             email!="e"? TextSpan(text: email,style: paraBoldText):TextSpan(text: ""),
         address!="e" ?TextSpan(text: ". I live at  ",style: paraText):TextSpan(text: ""),
             address!="e"? TextSpan(text: address,style: paraBoldText):TextSpan(text: ""),
